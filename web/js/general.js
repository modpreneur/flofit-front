...
function getPlayer(file1,file2,poster,category,w,h,container) {	
	...
	jwplayer(container).setup({
		        ...
		        events: {
		        	onPlay: function(evt) { ga('send','event', category, 'Play', file1);}, 
		        	onPause: function(evt) { ga('send','event', category, 'Pause', file1);},
		        	onBuffer: function(evt) { ga('send','event', category,'Buffering', file1); }
		        	}
		       		    });
	if (playOnLoad) {
